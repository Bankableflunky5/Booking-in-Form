...
import { NameRow, ContactRow, AddressRow, HowHeard, DeviceType, DeviceBrand, Issue, Password } from "./components/Inputs";
...
const { submit, loading, errorMessage, setErrorMessage, goSuccess } = useSubmitBooking(env.apiUrl, jobID);
...
<button onClick={handleResetForm} className="text-sm text-gray-500 underline">Reset form</button>
